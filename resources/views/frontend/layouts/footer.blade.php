        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-5 col-lg-4 col-xl-3">
                <div class="single_footer_area mb-100">
                    ...
                    <div class="footer_social_area mt-15">
                        ...
                        <a href="index-2.html#"><i class="fa fa-dribbble" aria-hidden="true"></i></a>
                        <a href="index-2.html#"><i class="fa fa-rss" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md col-lg-4 col-xl-2">
                <div class="single_footer_area mb-100">
                    ...
                    <ul class="footer_widget_menu">
                        <li><a href="index-2.html#"><i class="icofont-rounded-right"></i> Your Account</a></li>
                        <li><a href="index-2.html#"><i class="icofont-rounded-right"></i> Free Shipping Policy</a></li>
                        <li><a href="index-2.html#"><i class="icofont-rounded-right"></i> Your Cart</a></li>
                        <li><a href="index-2.html#"><i class="icofont-rounded-right"></i> Return Policy</a></li>
                        <li><a href="index-2.html#"><i class="icofont-rounded-right"></i> Free Coupon</a></li>
                        <li><a href="index-2.html#"><i class="icofont-rounded-right"></i> Delivary Info</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md col-lg-4 col-xl-2">
                <div class="single_footer_area mb-100">
                    ...
                    <ul class="footer_widget_menu">
                        <li><a href="index-2.html#"><i class="icofont-rounded-right"></i> Product Support</a></li>
                        <li><a href="index-2.html#"><i class="icofont-rounded-right"></i> Terms &amp; Conditions</a></li>
                        <li><a href="index-2.html#"><i class="icofont-rounded-right"></i> Help</a></li>
                        <li><a href="index-2.html#"><i class="icofont-rounded-right"></i> Payment Method</a></li>
                        <li><a href="index-2.html#"><i class="icofont-rounded-right"></i> Affiliate Program</a></li>
                        <li><a href="index-2.html#"><i class="icofont-rounded-right"></i> Privacy Policy</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-12 col-md-7 col-lg-8 col-xl-3">
                ...
                <div class="single_footer_area mb-100">
                    ...
                    <div class="apps_download">
                        <a href="index-2.html#"><img src="img/core-img/play-store.png" alt="Play Store"></a>
                        <a href="index-2.html#"><img src="img/core-img/app-store.png" alt="Apple Store"></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="copywrite_text">
                        <p>Made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="index-2.html#">Designing World</a></p>
                    </div>
                </div>
                <!-- Payment Method -->
                <div class="col-12 col-md-6">
